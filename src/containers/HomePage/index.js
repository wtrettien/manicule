                    ...
                    <Row>
                        <Col sm={8}>
                            <div className="home-text">
                                ...
                                />
                                <p>
                                    This manuscript is an eleven-leaf fragment of Geoffrey Chaucer’s{' '}
                                    <i>The Canterbury Tales</i>, held at the Rosenbach in
                                    Philadelphia, Pennsylvania. It includes portions of the{' '}
                                    <span
                                        style={{
                                    ...
                                    (English MS. 63) are all that survive of the “Oxford
                                    Manuscript.”
                                </p>
                                <p>
                                    <img
                                    ...
                                    for exploring unique books and manuscripts. The <b>Browse</b>{' '}
                                    view allows you to read the fragments in order, following the
                                    modern pagination on the leaves and bifolia. Marginal notes
                                    beside each facsimile page indicate which lines from{' '}
                                    <i>The Canterbury Tales</i> are present; these notes can be
                                    changed by altering the <b>description</b> attribute in{' '}
                                    <b>pages.json</b>. Color-coded categories indicate which tale is
                                    present; these categories can also be changed in{' '}
                                    <b>pages.json</b> and the colors updated in <b>metadata.ts</b>.
                                    (They have been added by hand to the paragraph above, to
                                    demonstrate how to add styles to this text.) The{' '}
                                    <b>Structure</b> view shows where these fragments are conjoined,
                                    or not. This data is stored in <b>structure.xml</b>, which
                                    visualizes the format of a book using the{' '}
                                ...
                                <p>
                                    ...
                                    heritage materials along with machine-readable descriptive and
                                    technical metadata.
                                </p>
                                <p>
