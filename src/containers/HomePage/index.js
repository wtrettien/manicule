                                ...
                                <Col sm={8}>
                                    <div className="home-text">
                                        ...
                                        <p>
                                            ...
                                            Chaucer’s <i>The Canterbury Tales</i>, held at the
                                            Rosenbach in Philadelphia, Pennsylvania. It includes
                                            portions of the{' '}
                                            <span
                                                style={{
                                            ...
                                            Library (English MS. 63) are all that survive of the
                                            “Oxford Manuscript.”
                                        </p>
                                        <p>
                                            <img
                                            ...
                                            bifolia. Marginal notes beside each facsimile page
                                            indicate which lines from <i>The Canterbury Tales</i>{' '}
                                            are present; these notes can be changed by altering the{' '}
                                            <b>description</b> attribute in <b>pages.json</b>.
                                            Color-coded categories indicate which tale is present;
                                            these categories can also be changed in{' '}
                                            <b>pages.json</b> and the colors updated in{' '}
                                            <b>metadata.js</b>. (They have been added by hand to the
                                            paragraph above, to demonstrate how to add styles to
                                            this text.) The <b>Structure</b> view shows where these
                                            fragments are conjoined, or not. This data is stored in{' '}
                                            <b>structure.xml</b>, which visualizes the format of a
                                            book using the{' '}
                                            <a href="https://github.com/leoba/VisColl">VisColl</a>{' '}
                                            data model.
                                        </p>
                                        <p>
                                            Images of and information about this manuscript (MS
                                            1084/2) were accessed via{' '}
                                        ...
                                        <p>
                                            For instructions on how to install and play with this
                                            demo, please see the README of the source code:{' '}
                                            <a href="https://github.com/wtrettien/manicule">
                                ...
                                <Col sm={4}>
                                    <ListGroup>
                                        ...
                                        <ListGroupItem>
                                            <Link to="/structure">
                                                {' '}
                                                <Glyphicon glyph="book" /> Explore the book‘s
                                                physical structure
                                            </Link>
                                        </ListGroupItem>
                                    </ListGroup>
...
export default connect(mapStateToProps, { setEdition })(HomePage)
